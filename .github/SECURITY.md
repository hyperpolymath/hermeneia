...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/hermeneia/security/advisories/new)
...
If you cannot use GitHub Security Advisories, you may email the maintainer directly:

| | |
|---|---|
| **Email** | j.d.a.jewell@open.ac.uk |

Please include the detail described in [What to Include](#what-to-include). A PGP-encrypted report can be arranged on request.
...
- This repository (`hyperpolymath/hermeneia`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/hermeneia/security/advisories)
...
When using Hermeneia, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/hermeneia/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/hermeneia/security/advisories/new) or j.d.a.jewell@open.ac.uk |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/hermeneia/discussions) |
...
*Thank you for helping keep Hermeneia and its users safe.* 🛡️
